...
QMap<QString, int> VerifyOrphanFunctions::checkForOrphanFunctions(QMap<QString, int> p_functionsMap)
{
...
void VerifyOrphanFunctions::UpdateTodoList(QMap<QString, int> p_functionsMap )
{
    qDebug() << "UpdateTodoList: " << p_functionsMap;
    foreach(QString l_function, p_functionsMap.keys())
    {
